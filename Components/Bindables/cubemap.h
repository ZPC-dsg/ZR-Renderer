...
namespace Bind {
	...
	public:
		...
		CubeMap(const std::string& tag, std::shared_ptr<RawTexture2D> cubemap, const OGL_TEXTURE_PARAMETER& param, GLuint unit, bool generate_mip = false);
		~CubeMap() = default;
		...
		static std::shared_ptr<CubeMap> Resolve(const std::string& tag, std::shared_ptr<RawTexture2D> cubemap, const OGL_TEXTURE_PARAMETER& param, GLuint unit, bool generate_mip = false);
		...
		static std::string GenerateUID(const std::string& tag, std::shared_ptr<RawTexture2D> cubemap, const OGL_TEXTURE_PARAMETER& param, GLuint unit, bool generate_mip = false);
