...
namespace Bind {
	...
	public:
		...
		ImageTexture2D(const std::string& tag, const OGL_TEXTURE2D_DESC& desc, const OGL_TEXTURE_PARAMETER& param, GLuint unit, void* data = nullptr, bool generate_mip = false);
		...
		static std::shared_ptr<ImageTexture2D> Resolve(const std::string& tag, const OGL_TEXTURE2D_DESC& desc, const OGL_TEXTURE_PARAMETER& param, GLuint unit, void* data = nullptr, bool generate_mip = false);
		...
		static std::string GenerateUID(const std::string& tag, const OGL_TEXTURE2D_DESC& desc, const OGL_TEXTURE_PARAMETER& param, GLuint unit, void* data = nullptr, bool generate_mip = false);
